...
export default function ContactSection() {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-[15vw] font-bold leading-[0.8] tracking-[-0.03em] text-center whitespace-nowrap">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-32 min-h-screen flex flex-col justify-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="flex flex-col items-start relative">
            ...
            <motion.div 
              className="absolute top-0 right-20 w-16 h-16 rounded-full overflow-hidden border border-white/20"
              whileHover={{ rotate: 15, scale: 1.1 }}
            >
              <img src="https://images.unsplash.com/photo-1583864697784-a0efc8379f70?q=80&w=200&auto=format&fit=crop" alt="Profile" className="w-full h-full object-cover" />
            </motion.div>
          ...
          <div className="relative min-h-[600px] flex flex-col justify-center">
            ...
            <motion.div 
              className="mt-24 pt-12 border-t border-white/10 grid grid-cols-2 gap-12"
              initial={{ opacity: 0 }}
            ...
            >
              <div>
                ...
                <div className="flex flex-col gap-4">
                  <a href="mailto:hello@example.com" className="group relative w-fit">
                    hello@example.com
                    <span className="absolute -bottom-1 left-0 w-0 h-[1px] bg-white transition-all duration-300 group-hover:w-full"></span>
                  </a>
                  <a href="tel:+1234567890" className="group relative w-fit">
                    +1 (234) 567-890
                    <span className="absolute -bottom-1 left-0 w-0 h-[1px] bg-white transition-all duration-300 group-hover:w-full"></span>
                  </a>
                </div>
              ...
              <div>
                ...
                <div className="flex flex-col gap-4">
                  {['GitHub', 'LinkedIn', 'Twitter'].map((social) => (
                    <a key={social} href="#" className="group relative w-fit">
                      {social}
                      <span className="absolute -bottom-1 left-0 w-0 h-[1px] bg-white transition-all duration-300 group-hover:w-full"></span>
                    </a>
                  ))}
      ...
      <div className="absolute bottom-[2vh] left-0 w-full whitespace-nowrap text-[10vw] leading-none text-white/10 font-medium z-0 pointer-events-none flex items-end overflow-hidden" style={{ letterSpacing: '-0.06em' }}>
        <div ref={marqueeRef} className="flex w-max -translate-x-1/2">
